...
SELECT UnitPrice AS 'Oeiginal Price',UnitPrice*0.18 AS 'tax Price',UnitPrice*1.18 AS 'Market Price', ProductName AS 'Product Name'
FROM Products

SELECT UnitPrice*1.18 AS 'Market Price', ProductName+' : ' + QuantityPerUnit AS 'Product Info'
FROM Products
